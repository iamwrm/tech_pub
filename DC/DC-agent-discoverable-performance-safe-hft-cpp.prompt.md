```
Read https://modem.dev/blog/how-coding-agents-read-your-code
What is the takeaway for HFT C++ developer

Reply in Chinese while retaining key technical terms in English.

基于这个文章， 和下面的RFC， 生成一个DC文件， 在code block中, the output should be in pure english because it will be durable artifacts
